						...
						<div class="col-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									...
									<form class="forms-sample" action="addProduct" method="post"
										enctype="multipart/form-data">

										<input type="hidden" name="pid" value="${product.pid}">

										<div class="form-group">
											<label for="exampleSelectGender">Category</label> <select
										...
										<div class="form-group">
											<label for="exampleInputName1">Product Price</label> <input
												type="text" class="form-control" name="price"
												id="exampleInputName1" placeholder="Product Price"
												value="${product.productPrice}">
										</div>
										<div class="form-group">
											<label for="exampleInputName1">Product Quantity</label> <input
												type="text" class="form-control" name="qty"
												id="exampleInputName1" placeholder="Product Quantity"
											...
											<tbody>
												<c:forEach items="${products}" var="pro">
													<tr>
														...
														<td><img alt="${pro.getProductImage()}"
															src="img/${pro.getProductImage()}" height="50" width="50"></td>
														<td><a href="deletepro?id=${pro.getPid()}"
															class="btn btn-danger">DELETE</a></td>
														<td><a href="editpro?id=${pro.getPid()}"
